...
# driver.get('https://paultan.org/2022/03/11/dc-fast-chargers-in-malaysia-the-full-list-of-locations/')
...
# elements = driver.find_elements(By.CLASS_NAME, "post-content")
...
#
# # filter unwanted texts
# open('paulfinal.csv', 'w').writelines(line for line in open('paul.csv') if not 'location link' in line)
#
# if (os.path.isfile('paul.csv') and os.path.isfile('paulfinal.csv')):
#     os.remove('paul.csv')
#     print("file deleted")
# else:
...
data = pd.read_csv("Paultancleaned.csv")
