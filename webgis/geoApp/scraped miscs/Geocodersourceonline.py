...
API_KEY = 'AIzaSyB9-TQpzo1bAJuSBXnYMpCCyXgJbE86h50'
# Backoff time sets how many minutes to wait between google pings when your API limit is hit
BACKOFF_TIME = 30
# Set your output file name here.
output_filename = 'Governmentfinala.csv'
# Set your input file here
input_filename = "Government.csv"
# Specify the column name in your input data that contains addresses here
address_column_name = "locations"
...
data = pd.read_csv(input_filename, encoding='utf8', error_bad_lines=False)
...
# if len(fname) < 1 : fname = output_filename
#
...
#         # lat = lat.strip("\"")
#         # lng = lng.strip("\"")
#         cur.execute('''INSERT INTO Shopping (locations,lat,lng)
