...
driver.get('https://www.starbucks.com.my/stores/#search-stores')
...
elements = driver.find_elements(By.CLASS_NAME, "store-name")
...
# AddressTitle
# elements2 = driver.find_elements(By.CLASS_NAME, "add")
#
# addressesTitle = []
#
...
with open('latlngstarbucks.csv', 'w') as f:
...
df = pd.read_csv("latlngstarbucks.csv")
# checking the number of empty rows in th csv file
print(df.isnull().sum())
# Droping the empty rows
modifiedDF = df.dropna()
# Saving it to the csv file
modifiedDF.to_csv('latlngstarbucks.csv', index=False)


with open('latlngstarbucks.csv', 'r') as in_file, open('latlngstarbucks2.csv', 'w') as out_file:
...
if(os.path.exists('latlngstarbucks.csv') and os.path.isfile('latlngstarbucks2.csv')):
  os.remove('latlngstarbucks.csv')
  print("file deleted")
else:
  print("file not found")

# import back the csv
data = pd.read_csv ("latlngstarbucks2.csv")
